...
public class JavaExample_02_StringBuffer
{
	public static void main(String[] args)
	{
		...
		// It accepts a String argument that sets the initial contents of the
